...
const en = {
  Title: "Sentral Chat",
  Subtitle: "Private AI. In your browser.",
  WIP: "Coming Soon...",
  ChatItem: {
  ...
  ModelSelect: {
    ...
    Subtitle: "Choose a model, then select a variant to get started",
    SearchPlaceholder: "Search model...",
    FilterButton: "Filters",
    FilterFamily: "Model Type",
    FilterSize: "Parameter size",
    SortLabel: "Sort by",
    SortOption: {
      Score: "Benchmark score",
      Name: "Name",
      Parameter: "Parameter size",
      VRAM: "VRAM (low to high)",
      Context: "Context window",
    },
    SizeCategory: {
      Small: "Small (<3B)",
      Standard: "Standard (3-7B)",
      Medium: "Medium (7-30B)",
      Large: "Large (30B+)",
    },
    ...
    EmptySearch: "Search",
    EmptyFamily: "Model Type",
    EmptySize: "Parameter size",
    EmptyNoFilters: "No filters applied",
  },
  UI: {
    Confirm: "Confirm",
    Cancel: "Cancel",
  ...
  ServiceWorker: {
    Error:
      "The WebLLM worker has lost connection. Please close all tabs of Sentral Chat and try opening Sentral Chat again.",
  },
  MlcLLMConnect: {
